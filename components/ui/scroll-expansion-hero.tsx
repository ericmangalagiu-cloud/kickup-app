            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date && (
                    <p
                      className='text-sm font-semibold text-green-300 tracking-widest uppercase'
              ...
              >
                <motion.h2
                  className='text-5xl md:text-7xl lg:text-8xl font-black text-white transition-none drop-shadow-2xl'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                {restOfTitle && (
                  <motion.h2
                    className='text-5xl md:text-7xl lg:text-8xl font-black text-center transition-none drop-shadow-2xl'
                    style={{
